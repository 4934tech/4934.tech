            ...
            <div className={`mx-auto ${
                ...
                <div className={`${
                    ...
                    <div className={centered ? '' : 'lg:pr-4'}>
                        ...
                        {links.length > 0 && (
                            <div className={`mt-10 flex items-center gap-x-6 ${centered ? 'justify-center' : ''}`}>
                                {links.map((link) => (
                                    <Link
                                        key={link.name}
                                        href={link.href}
                        ...
                        {stats.length > 0 && (
                            <dl className={`mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 ${centered ? 'lg:grid-cols-4' : ''}`}>
                                {stats.map((stat) => (

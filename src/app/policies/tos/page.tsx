        ...
        <>
            <div className="mt-16 isolate px-6 py-24 sm:py-32 lg:px-8">
                <div className="mx-auto max-w-4xl px-6 lg:px-8">
                    <h2 className="text-5xl font-bold tracking-tight text-white sm:text-7xl">Terms of Service</h2>
                    <p className="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
                        Effective Date: December 17th, 2024
                    </p>
                    <p className="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
                        Welcome to 4934.tech / 4934 Tech (&quot;we,&quot; &quot;our,&quot; &quot;us&quot;). By accessing or using our website, services, or community features (&quot;Services&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree, please do not use our Services.
                    </p>
                    <p className="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
                    ...
                    <ul className="mt-3 text-pretty text-lg font-medium text-gray-300 list-disc list-inside">
                        ...
                        <li>Avoid sharing or posting harmful, illegal, or inappropriate content.</li>
                        <li>Refrain from harassment, hate speech, or spamming.</li>
                    ...
                    <hr className="mt-12 border-t-1 border-gray-700"/>
                    <p className="mt-8 text-pretty text-lg font-medium text-gray-300">
                        By using our Services, you agree to abide by these Terms of Service. Thank you for being part of the 4934.tech community!
                    </p>
                </div>
            </div>
        </>
